...
public String getPassword1(String s,int ch)throws Exception   // accepts password from mini class
{	
	plainText=s;
	
	
	if(ch==0)//TO ENCRYPT USER SENT STRING
        {
            String encryptedText = AES.encrypt(plainText);	
            System.out.println("Encrypted Text:"+encryptedText);
            return encryptedText;
        }
        else if(ch==1)//TO DECRYPT USER SENT STRING
        {
            String decryptedText = AES.decrypt(plainText);
